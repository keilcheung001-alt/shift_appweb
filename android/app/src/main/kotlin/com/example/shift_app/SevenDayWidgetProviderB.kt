            ...
            try {
                ...
                for (i in 0..6) {
                    ...
                    if (arr != null) {
                        ...
                        Log.d("SevenDayWidgetB", "$dateKey -> ${leavers.size}人")
                    } else {
                        leaveMap[dateKey] = emptyList()
                        Log.d("SevenDayWidgetB", "$dateKey -> 0人")
                    }
                }
            } catch (e: Exception) {
                Log.e("SevenDayWidgetB", "讀取失敗", e)
            }
        } else {
            Log.e("SevenDayWidgetB", "full_month_leaves_B 為 null")
        }
