            ...
            try {
                ...
                for (i in 0..6) {
                    ...
                    if (arr != null) {
                        ...
                        Log.d("SevenDayWidgetA", "$dateKey -> ${leavers.size}人")
                    } else {
                        leaveMap[dateKey] = emptyList()
                        Log.d("SevenDayWidgetA", "$dateKey -> 0人")
                    }
                }
            } catch (e: Exception) {
                Log.e("SevenDayWidgetA", "讀取失敗", e)
            }
        } else {
            Log.e("SevenDayWidgetA", "full_month_leaves_A 為 null")
        }
