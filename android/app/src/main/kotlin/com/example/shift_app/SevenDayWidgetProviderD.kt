            ...
            try {
                ...
                for (i in 0..6) {
                    ...
                    if (arr != null) {
                        ...
                        Log.d("SevenDayWidgetD", "$dateKey -> ${leavers.size}人")
                    } else {
                        leaveMap[dateKey] = emptyList()
                        Log.d("SevenDayWidgetD", "$dateKey -> 0人")
                    }
                }
            } catch (e: Exception) {
                Log.e("SevenDayWidgetD", "讀取失敗", e)
            }
        } else {
            Log.e("SevenDayWidgetD", "full_month_leaves_D 為 null")
        }
